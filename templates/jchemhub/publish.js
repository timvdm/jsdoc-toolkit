...
function publish(symbolSet) {
	...
	try {
		...
		var classesTemplate = new JSDOC.JsPlate(publish.conf.templatesDir+"contents.tmpl");
	}
	catch(e) {
	...
	var files = JSDOC.opt.srcFiles;
 	...
 	var pages = symbols.filter(isaPage).sort(makeSortby("alias"));
        var classes_pages = { classes: classes, pages: pages };
	
	// create a class index, displayed in the left-hand column of every class page
	Link.base = "../";
 	publish.classesIndex = classesTemplate.process(classes_pages); // kept in memory
